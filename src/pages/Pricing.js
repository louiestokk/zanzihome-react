...
Boost Validity: ${startStr} to ${endStr}
  ...
  return (
    <div className="pricing-page-container">
      <Helmet>
        <meta charSet="utf-8" />
        <title>Pricing & Plans | ZanziHome Real Estate</title>
        <meta
          name="description"
          content="Choose a listing package or boost package to sell or rent out your property in Zanzibar. View listing fees and boost pricing."
        />
        <link rel="canonical" href="https://www.zanzihome.com/pricing" />
      </Helmet>
            ...
            <>
              ...
              {userProperties.length > 0 ? (
                ...
                <div style={{ textAlign: "center", padding: "20px 0" }}>
                  ...
                  <Link to="/checkout" className="action-btn" style={{ display: "inline-block", width: "auto" }}>
