...
const RealEstate = () => {
  ...
  const articleStructuredData = {
    ...
    "@type": "Article",
    title: "Real Estate in Zanzibar – Buy, Sell & Invest",
    description:
      "Discover real estate opportunities in Zanzibar. Buy, sell, or invest in beachfront homes, villas & land with trusted local experts.",
    image:
      "https://images.pexels.com/photos/14667295/pexels-photo-14667295.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
    datePublished: new Date("2025-06-30T09:25:01.340Z").toISOString(),
    author: {
      "@type": "Person",
      name: "Louie Stokk"
    }
  ...
  return (
    <section>
      ...
      <Helmet>
        <meta charSet="utf-8" />
        <title>
          {"Real Estate in Zanzibar – Buy, Sell & Invest"}
        </title>
        <meta
          name="description"
          content={
        ...
        <meta
          property="og:url"
          content="https://www.zanzihome.com//real-estate-zanzibar"
        />
        <meta
          property="og:description"
          content="Discover real estate opportunities in Zanzibar. Buy, sell, or invest in beachfront homes, villas & land with trusted local experts."
        />
        <meta
          property="og:image"
        ...
        <link
          rel="canonical"
          href="https://www.zanzihome.com//real-estate-zanzibar"
        />
      </Helmet>
      ...
      {(sale || rent) && type && area ? (
        ...
        >
         Zanzibar Real Estate – Properties for Sale & Rent
        </h1>
      )}
      <Objects />
