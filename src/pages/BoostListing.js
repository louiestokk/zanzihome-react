...
Price: $${propertyObj.Price}
      ...
      try {
        ...
        console.log("Boost confirmation copy sent to admin");
      } catch (err) {
        console.error("Failed to send boost email copy to admin:", err);
      }

      setEmailStatus({
        success: true,
        message: "We have received your request and will soon contact you."
      });
    } catch (err) {
      console.error(err);
      setEmailStatus({
  ...
  return (
    <div className="advertise-page-container">
      <Helmet>
        <meta charSet="utf-8" />
        <title>Boost Property Listings & Ads | ZanziHome</title>
        <meta
          name="description"
          content="Choose a premium boost package to sell or rent out your property in Zanzibar faster. Get featured badges and top-ranking search priority."
        />
        <link rel="canonical" href="https://www.zanzihome.com/boost-listing" />
      </Helmet>
      ...
      <header className="promo-hero">
        ...
        <h1 className="promo-hero-title">Boost Your Property Listing</h1>
        <p className="promo-hero-subtitle">
          Promote your property listing and get maximum visibility on ZanziHome. Reaches thousands of daily active buyers and renters looking for houses, villas, and plots in Zanzibar.
        </p>
      </header>
      ...
      {selectedPackage && (
        <section className="property-selector-box" ref={selectionRef}>
          ...
          <p style={{ margin: "0 0 20px 0" }} className="selector-subtitle">
          ...
          {userProperties.length > 0 ? (
            ...
            <div style={{ textAlign: "center", padding: "20px 0" }}>
              ...
              <Link to="/checkout" className="btn-boost-action" style={{ display: "inline-block", width: "auto" }}>
