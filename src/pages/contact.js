...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formEl) {
        const toEmailInput = formEl.querySelector("input[name='to_email']");
        if (toEmailInput) {
          toEmailInput.value = "louiestokk@gmail.com";
        }
      }
      await emailjs.sendForm(
        "service_thbibzh",
      ...
      console.log("Contact copy sent to admin");
      setStatus({
        success: true,
  ...
  return (
    <main className="contact-page-container">
      <Helmet>
        <meta charSet="utf-8" />
        <title>Customer Service & Support | ZanziHome Real Estate</title>
        <meta
          name="description"
          content="Contact ZanziHome customer support team. Ask questions about renting, buying, listing properties, beachfront plots or cars in Zanzibar."
        />
