  ...
  return (
    <main style={{ maxWidth: "1100px", margin: "0 auto", padding: "1.5rem" }}>
      <Helmet>
        ...
        <meta name="keywords" content={`invest in ${formattedArea}, property investment ${formattedArea}, buy plot ${formattedArea}, zanzibar real estate ROI`} />
