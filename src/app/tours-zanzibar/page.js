...
import { BsStarFill, BsCashCoin, BsCalendar4Week, BsClock, BsArrowRightShort } from "react-icons/bs";
import Faq from "../../components/Faq";

export const metadata = {
  title: "Zanzibar Tours and Safaris: Explore the Beauty of Africa's Paradise",
  description: "Embark on an unforgettable journey with Zanzibar tours and safaris. Explore pristine beaches, encounter diverse wildlife, and immerse yourself in the enchanting culture",
  alternates: {
    canonical: "https://www.zanzihome.com/tours-zanzibar",
  },
  openGraph: {
    url: "https://www.zanzihome.com/tours-zanzibar",
    title: "Zanzibar Tours and Safaris: Explore the Beauty of Africa's Paradise",
    description: "Embark on an unforgettable journey with Zanzibar tours and safaris. Explore pristine beaches, encounter diverse wildlife, and immerse yourself in the enchanting culture",
    images: [
      {
        url: "https://media.tacdn.com/media/attractions-splice-spp-674x446/0b/fe/13/eb.jpg",
      },
    ],
  },
};
...
const articleStructuredData = {
  ...
  "@type": "Article",
  headline: "Zanzibar Tours and Safaris: Explore the Beauty of Africa's Paradise",
  description: "Embark on an unforgettable journey with Zanzibar tours and safaris. Explore pristine beaches, encounter diverse wildlife, and immerse yourself in the enchanting culture",
  image: "https://media.tacdn.com/media/attractions-splice-spp-674x446/0b/fe/13/eb.jpg",
  datePublished: "2023-05-18T09:25:01.340Z",
  author: {
    "@type": "Person",
    name: "Louie Stokk"
  }
      ...
      <div id="toptoprated">
        <div style={{ textAlign: 'center' }}>
          ...
          <a style={{ color: 'inherit' }} href="https://huba-tours.com/" title="Huba Tours & Safari in Zanzibar">
            <img style={{ objectFit: 'cover', height: '100px' }} src="https://huba-tours.com/_next/image?url=https%3A%2F%2Fi.ibb.co%2F8DsN29v2%2Fhuba-tours-zanzibar.png&w=256&q=75" alt="Huba Tours" />
          </a>
          <p style={{ fontSize: '0.9rem', lineHeight: '23px', textAlign: 'center', padding: '0.5rem', width: '90%', margin: '0 auto' }}>
            Explore and <a style={{ color: 'inherit', textDecoration: 'underline' }} href="https://huba-tours.com/" title="book tours & safari">book tours & safaris in Zanzibar</a>, exclusive and personalized safari and tour experiences with our <strong>partner</strong> <a style={{ color: 'inherit', textDecoration: 'underline', fontWeight: '100' }} href="https://huba-tours.com/" title="Huba Tours & Safari Zanzibar">Huba Tours & Safari in Zanzibar</a>.
          </p>
        </div>
            ...
            <div key={i} className="toprateditem">
              ...
              <div style={{ padding: '1rem' }}>
                ...
                <div className="topratedstarsCont">
                  ...
                  <p style={{ marginLeft: '0.35rem', fontSize: '0.87rem' }}>
                    <strong>{el.reviews.stars}</strong>/5 - {el.reviews.num} <a style={{ textDecoration: 'underline' }} href="/reviews">Reviews</a>
                  </p>
                </div>
                <p style={{ fontSize: '0.9rem', lineHeight: '24px', marginTop: '0.5rem', marginBottom: '1rem', color: 'rgb(118, 116, 116)' }}>
                  {el.desc}
                </p>
                <div>
              ...
              <div style={{ display: 'flex', justifyContent: 'center', margin: '1rem 0' }}>
                <a href="https://www.huba-tours.com/" title={el.title}>
                  <button style={{ width: '280px', color: '#00BF93', backgroundColor: 'transparent', border: '0.5px solid #00BF93', padding: '0.5rem', cursor: 'pointer', borderRadius: '4px' }}>
                    Explore tour <BsArrowRightShort style={{ marginLeft: '1rem' }} />
                  </button>
                </a>
              </div>
            </div>
